...
ocument.addEventListener("DOMContentLoaded", function () {
    ...
    function changeLanguage(lang) {
        ...
        const heritage = document.getElementById("Urban Heritage");
        const activities = document.getElementById("Our Activities");
        const contact = document.getElementById("Contact Us");

        // Check if elements exist before setting texts
